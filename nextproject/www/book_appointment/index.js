...
function populateReferralCode() {
	...
	console.log("****ref code fet from url : ",referralCode)
    if (referralCode) {
...
function getReferralCodeFromURL() {
	console.log("****Inside get ref code from url function ")
...
async function submit() {
	...
	let referralCode = document.getElementById('ref_code').value;
	console.log(referralCode)
	let appointment = frappe.call({
		method: "nextproject.www.book_appointment.index.create_appointment",
