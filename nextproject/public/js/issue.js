frappe.ui.form.on("Issue", {
	setup: function (frm) {
        ...
        refresh: function (frm) {
            ...
            // frm.trigger("custom_email")
            if(frm.doc.status == "customer_verification_pending"){
                if(frm.doc.resolution_required != 1){
                    frm.set_value("resolution_reuired", 1)
                    frm.save();
                }
            }
...
//         console.log("jvbwvbowobewbnwv")
//         // Custom New Email Button Code;
//         let ccs;
//         let dg
//         if(!frm.is_new()){
//             frm.add_custom_button('New Email', () => {
//                 frappe.call({
//                     method:'nextproject.nextproject.custom_issue.get_contacts',
//                     args:{
...
//                         console.log(ccs)
//                         args.cc = ccs["nprimary"]
//                         args.recipients = ccs["primary"]
//                         new dg(args)
...
//             } );
//             dg = frappe.views.custom_email_issue = class {
//                 constructor(opts) {
//                     $.extend(this, opts);
//                     if (!this.doc) {
...
//                                 callback: (r) => {
//                                     ccs = r.message
//                                     // console.log("ttype",this.frm.meta.name)
//                                     this.dialog.fields_dict[field].set_data(ccs["primary"]);
//                                 }
//                             });
//                         };
//                     });
//                     ['bcc','cc'].forEach(field => {
//                         this.dialog.fields_dict[field].get_data = () => {
//                             const data = this.dialog.fields_dict[field].get_value();
//                             const txt = data.match(/[^,\s*]*$/)[0] || '';
...
//                                     ccs = r.message
//                                     // console.log("ttype",this.frm.meta.name)
//                                     this.dialog.fields_dict[field].set_data(ccs["nprimary"]);
//                                 }
//                             });
//                         };
//                     });
...
//                             print_letterhead: this.is_print_letterhead_checked(),
//                         },
//                         btn,
//                         callback(r) {
//                             if (!r.exc) {
